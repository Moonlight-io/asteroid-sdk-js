...
module.exports.CreateClaim = (network, claim, access_token, version = 1, id = "0") => {
  let params = {
    "version":      version,
    "access_token": access_token,
    "claim":        claim
  };
  return net.ExecuteMethod(network.adu, "User.CreateClaim", params, id)
};
...
module.exports.SubmitWorkflowToken = (network, dynamic_token, access_token, version = 1, id = "0") => {
  let params = {
    "version":       version,
    "access_token":  access_token,
    "dynamic_token": dynamic_token
  };
  return net.ExecuteMethod(network.adu, "User.SubmitWorkflowToken", params, id)
};
