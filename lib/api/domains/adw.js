...
module.exports.ClaimTask = (network, task_id, access_token, version) => {
  let params = {
    "version":      version,
    "access_token": access_token,
    "task_id":      task_id
...
module.exports.ResolveTask = (network, task_id, access_token, version) => {
  let params = {
    "version":      version,
    "access_token": access_token,
    "task_id":      task_id
...
module.exports.RegisterWorker = (network, access_point, access_token, version) => {
  let params = {
    "version":        version,
    "access_token":   access_token,
