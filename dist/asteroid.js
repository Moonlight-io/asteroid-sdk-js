...
var Asteroid = /** @class */ (function () {
    ...
    Asteroid.prototype.registerInterest = function (email) {
        return __awaiter(this, void 0, void 0, function () {
            var req;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, rpc_1.rpc.user.registerInterest(this.asteroidDomainUserBaseUrl, req, this.id)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    Asteroid.prototype.setDisableRegistration = function (secret, state) {
        return __awaiter(this, void 0, void 0, function () {
            var req;
            return __generator(this, function (_a) {
                switch (_a.label) {
