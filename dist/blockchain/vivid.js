...
var Vivid = /** @class */ (function () {
    function Vivid() {
    }
    Vivid.getDecryptedClaimByClaimID = function (network, neoCNSScriptHash, claimId, wif) {
    ...
    Vivid.getFormattedClaimByClaimID = function (network, claimsScriptHash, claimId) {
        return __awaiter(this, void 0, void 0, function () {
