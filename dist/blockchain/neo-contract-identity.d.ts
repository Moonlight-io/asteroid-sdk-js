...
export declare class NeoContractIdentity {
     ...
     * @param pointer
     */
    static getKeyByPointer(network: NetworkItem, contractHash: string, pointer: number): Promise<any>;
    /**
     * gets the write pointer for the keychain
     * @param network
     * @param contractHash
     */
    static getKeychainWritePointer(network: NetworkItem, contractHash: string): Promise<number | null>;
    /**
     ...
     * @param holder
     */
    static getKeyByHolder(network: NetworkItem, contractHash: string, holder: string, pointer: number): Promise<number[] | null>;
    /**
     ...
     * @param issuer
     */
    static getKeyByIssuer(network: NetworkItem, contractHash: string, issuer: string, pointer: number): Promise<number | null>;
    /**
     ...
     * @param sub
     */
    static getKeyByHolderSub(network: NetworkItem, contractHash: string, holder: string, sub: string, pointer: number): Promise<number | null>;
